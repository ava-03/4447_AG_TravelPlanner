  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          name="Trips"
          component={Trips as any}
          options={{ title: 'My Trips' }}
        />

        <Stack.Screen
          name="AddTrip"
          component={AddTrip as any}
          options={{ title: 'Add Trip' }}
        />

        <Stack.Screen
          name="EditTrip"
          component={EditTrip as any}
          options={{ title: 'Edit Trip' }}
        />

        <Stack.Screen
          name="TripDetails"
          component={TripDetails as any}
        ...
        <Stack.Screen
          name="AddCategory"
          component={AddCategory as any}
        />

        <Stack.Screen
          name="EditCategory"
          component={EditCategory as any}
        />

        <Stack.Screen
          name="Insights"
          component={Insights as any}
        />
        ...
        <Stack.Screen
          name="AddActivity"
          component={AddActivity as any}
        />

        <Stack.Screen
          name="EditActivity"
          component={EditActivity as any}
        />

        <Stack.Screen
          name="AddTarget"
          component={AddTarget as any}
        />

        <Stack.Screen
          name="EditTarget"
          component={EditTarget as any}
        />
